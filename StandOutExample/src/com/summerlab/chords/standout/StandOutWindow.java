...
public abstract class StandOutWindow extends Service {
	...
	public PopupWindow getDropDown(final int id) {
		final List<DropDownListItem> items = new ArrayList<StandOutWindow.DropDownListItem>();

		// add default drop down items
		items.add(new DropDownListItem(
				android.R.drawable.ic_menu_close_clear_cancel, "Turn off",
				new Runnable() {
	...
	public final void setIcon(int id, int drawableRes) {
		...
		if (window != null) {
			...
			if (icon instanceof ImageView) {
				((ImageView) icon)
						.setImageResource(R.drawable.chord_back_orange);
			}
		}
	}
